  ...
  return (
    <div className='min-h-screen bg-gradient-to-br from-gray-50 to-emerald-50 py-10'>
      <div className='w-[90vw] lg:w-[70vw] max-w-[90%] mx-auto'>
        <div className='mb-10 w-full flex flex-wrap items-center gap-4'>
          <button 
          onClick={()=>navigate("/")}
          className='mt-1 p-3 rounded-full bg-white shadow hover:shadow-md transition cursor-pointer'>
            ...
            <div>
              <h1 className='text-3xl flex-nowrap font-bold text-gray-800 '>Interview History</h1>
            ...
            {Interviews.map((item, index)=>(
              ...
              <div className='flex flex-col md:flex-row md:items-center md:justify-between gap-4'>
                <div>
                  ...
                  <p className='text-gray-400 text-xs mt-2'> {new Date(item.createdAt).toLocaleDateString()}</p>
                </div>
