          ...
          <div className='flex flex-col md:flex-row justify-center items-center gap-10 mb-28'>
            {
              [
                ...
                desc: "Real interview pressure with time trac"
                }
              ].map((item,index)=>(
                ...
                className={`
                  relative bg-white rounded-3xl border-2 border-gray-100 hover:border-green-500 p-10 w-80 max-w-[90%] shadow-md hover:shadow-2xl transition-all duration-300
                  ${index===0 ? "rotate-[-4deg]" : ""}
              ...
              <div className='grid md:grid-cols-2 gap-10'>
                {
                  [
                    ...
                    },
                    {
                      ...
                      desc: "Track your progress with performance graph and topic analysis."
                    },
                  ].map((item, index)=>(
                    <motion.div key={index}
                    initial={{opacity:0 , y:30}}
              ...
              <div className='grid md:grid-cols-2 gap-10'>
                {
                  [
                    ...
                    },
                    {
                      ...
                      desc: "Deep Technical questioning based on selection role."
                    },
                    {
                      img: confidenceImg,
