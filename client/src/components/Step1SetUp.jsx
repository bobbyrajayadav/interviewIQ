...
const handleStart = async () =>{
  ...
  try {
    ...
    // Yahan par console.log laga diya taaki aap seedha console me data dekh sako!
    console.log("Interview Data Received:", res.data)
           ...
           Interview Setup
            ...
            <div className='space-y-6'>
              ...
              <div className='relative'>
                ...
                className='w-full p-12 pr-4 py-3 border border-gray-200 rounded-xl focus:ring-2 focus:ring-green-500 outline-none transition'>
                ...
                {!analysisDone && (
                  ...
                  className='border-2 border-dashed border-gray-300 rounded-xl p-8 text-center hover:border-green-500 hover:bg-green-50 transition cursor-pointer'>
