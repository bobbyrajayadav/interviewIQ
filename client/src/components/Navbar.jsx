...
function Navbar() {
  ...
  return (
    <div className='bg-[#f3f3f3 flex justify-center px-4 pt-6' >
        ...
        className='w-full max-w-6xl bg-white rounded-[24px] shadow-sm border border-gray-200 px-8 py-4 
        flex justify-between items-center relative'>
            ...
            <div className='flex items-center gap-6 relative'>
                <div className='relative'>
                    ...
                    setShowCreditPopup
                    (!showCreditPopup); setShowUserPopup(false)}} className='flex items-center gap-2 bg-gray-100 
                ...
                <div className='relative'>
                    ...
                    {showUserPopup && (
                        ...
                        p-4 z-50'>
                            ...
                            className='w-full text-left text-sm py-2 flex item-center gap-2 text-red-500 cursor-pointer'>
