...
// file ko read karne ke liye hame ek pdfjs-dist package install karna hai 
export const analyzeResume = async (req, res) => {
    try {
        ...
        //read file karega fs module se 
        const fileBuffer = await fs.promises.readFile(filePath) // file read ho gai and binary data aagya hai
        //ab file ke binary data ko pdffs-dist bali format me change karna hai
...
`
        ...
        fs.unlinkSync(filePath)     //resume analyze karke file ko delete kar dega 
...
//interview create karne ke liye controller 
...
export const getMyInterviews = async (req, res) => {
    try {
        ...
        return res.status(500).json({ message: `Failed to find currentUser interviews: ${error}` })
    }
}
